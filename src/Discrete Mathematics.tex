...
\begin{document}
    ...
    \begin{proof}
    Suppose that the harmonic series converges, thus $$\exists S \mid \sum_{k = 1}^{+ \infty}{\dfrac{1}{k}} = S$$ then we have that $$\centeredsoe{S = 1 + \dfrac{1}{2} + \dfrac{1}{3} + \dfrac{1}{4} + \dfrac{1}{5} + \dfrac{1}{6} \ldots = \\ = \rbk{1 + \dfrac{1}{2}}} + \rbk{\dfrac{1}{3} + \dfrac{1}{4}} + \rbf{\dfrac{1}{5} + \dfrac{1}{6}} + \ldots > \\ > \rbk{\dfrac{1}{2} + \dfrac{1}{2}}} + \rbk{\dfrac{1}{4} + \dfrac{1}{4}} + \rbf{\dfrac{1}{6} + \dfrac{1}{6}} + \ldots = \\ = 1 + \dfrac{1}{2} + \dfrac{1}{3} + \ldots = S$$ implying that $S > S \lightning$.
    \end{proof}
    ...
    \begin{proof}
        Consider the following inequality $$\forall n \in \N \quad \prod_{p \in \Primes TODO}{\rbk{\dfrac{p}{p - 1}}} > \sum_{k = 1}^{n}{\dfrac{1}{k}}$$ this can be proven by using the MISSING CREF as follows: $$\forall p \in \Primes \mid p \leq n \quad \dfrac{p}{p - 1} = \dfrac{1}{\dfrac{p - 1}{p}} = \dfrac{1}{1 - p} = \sum_{k = 0}^{+ \infty}{\dfrac{1}{p^k}} = 1 + \dfrac{1}{p} + \dfrac{1}{p^2} + \ldots$$ which is the infinite sum of the reciprocal of the powers of some prime number $p$, meaning that $$\exists p_1, \ldots p_j \in \Primes \mid \prod_{p \in \Primes TODO}{\rbk{\dfrac{p}{p - 1}}} = p_1 \cdot \ldots \cdot p_j = \sum_{k = 0}^{+ \infty}{\dfrac{1}{p_1^k}} \cdot \ldots \cdot  \sum_{k = 0}^{+ \infty}{\dfrac{1}{p_j^k}}$$ and thanks to the \cref{upf} this product expands to the sum of the reciprocal of every natural number that has $p_1, \ldots, p_j$ in his prime factorization, namely $$TODO$$ and since $p_1, \ldots, p_j <= n$, because of the \cref{upf} this summation must contain at least every term contained inside $\sum_{k = 1}^{n}{\dfrac{1}{k}}$, which proves the inequality.
    \end{proof}
    palle
