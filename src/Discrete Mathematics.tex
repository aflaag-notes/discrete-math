...
\usepackage{nyx-packages}
\usepackage{nyx-styles}
\usepackage{nyx-frames}
\usepackage{nyx-title}
\usepackage{nyx-macros}
...
\title{Titolo}
\subtitle{Appunti integrati con il libro "Titolo Libro", Autore 1, Autore 2, ...}
