...
\begin{document}
    ...
    \begin{example}[ICF of the Golden Ratio]
        TODO
    \end{example}
    ...
    \begin{framedprob}{Limits of continued fractions}
        \begin{enumerate}
            ...
            \item Consider the following sequence: $$\dfrac{25}{16}, \dfrac{49}{36}, \dfrac{81}{64}, \dfrac{121}{100}, \ldots$$ Computed the continued fractions of these ratios; what is the limit of this sequence?
        \end{enumerate}
    \end{framedprob}
